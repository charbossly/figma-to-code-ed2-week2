  ...
  return (
    <div className="py-12">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
        {/* Left Card */}
        <div className="relative w-full md:w-1/2 xl:w-1/3 h-111 bg-gray-200  rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
            <Suspense fallback={<div>Loading...</div>}>
              <button className="px-5 py-3 text-t14 font-Archivo bg-white text-b-black rounded-full shadow-lg flex items-center justify-center font-semibold space-x-2 hover:bg-gray-100 ">
        ...
        {/* Right Card */}
        <div className="relative w-full md:w-1/2 xl:w-2/3 h-111 bg-gray-200 rounded-lg overflow-hidden">
          <Image
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <h3 className=" text-2xl font-bold text-center">
              ...
              <span className="text-sm font-normal text-white font-Archivo text-t14">
                ...
                {reduceText(collections[1]?.node?.description || "")}
              </span>
            </h3>
          </div>
        </div>
